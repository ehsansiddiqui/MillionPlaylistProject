...
def create_dataframes(data_path, challenge_file, output_path, partitions):
    ...
    df_playlists_test_info.write.parquet(f"{output_path}/df_playlists_test_info_spark", mode="overwrite")
    df_playlists_test.write.parquet(f"{output_path}/df_playlists_test_spark", mode="overwrite")
...
if __name__ == "__main__":
    # Define paths
    data_path = "../CFDS/data/raw/"  # Path to directory with JSON files
    challenge_file = "../CFDS/data/raw/challenge_set.json"  # Challenge set file
    output_path = "../CFDS/data/processed"  # Output directory for CSV files
